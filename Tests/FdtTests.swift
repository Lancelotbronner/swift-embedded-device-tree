...
import Testing
import Foundation
import EmbeddedDeviceTree

func include_bytes(_ name: String) throws -> Data {
	let url = Bundle.module.url(forResource: name, withExtension: "dtb", subdirectory: "dtb")
